...
EAStep vivado -log Lab5_Team28_Vending_Machine_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab5_Team28_Vending_Machine_fpga.tcl -notrace
