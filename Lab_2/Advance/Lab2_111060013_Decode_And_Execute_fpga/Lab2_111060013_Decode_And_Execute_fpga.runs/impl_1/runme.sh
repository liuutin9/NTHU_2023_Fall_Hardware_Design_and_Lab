...
HD_PWD='D:/Logic_Design_Lab/Lab_2/Advance/Lab2_111060013_Decode_And_Execute_fpga/Lab2_111060013_Decode_And_Execute_fpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Center.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Center.tcl -notrace
